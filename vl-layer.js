...
/* harmony default export */ var dragvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    max: function max() {
      ...
      dom.style["transform"] = "inital";
      if(this.options.canmove){
        dom.getElementsByClassName("vl-notice-title")[0].style["cursor"] = "inital";
      }
    },
    maxmini: function maxmini() {
      ...
      if(this.options.canmove){
        dom.getElementsByClassName("vl-notice-title")[0].style["cursor"] = "move";
      }
    },
...
var layer_Notification = function Notification(Vue) {
  ...
  self.open = function (options) {
    ...
    if(!options.canmove){
      document.getElementById(options.id).getElementsByClassName("vl-notice-title")[0].style["cursor"] = "initial";
    }
